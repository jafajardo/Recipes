...
import { updateSelectedCategories, removeSelectedCategory } from '../actions/index';
        ...
        return (
          <div className="card m-3" key={recipe._id}>
            ...
            <div className="card-block text-center">
              ...
              <Link className="btn btn-secondary" to={ `recipes/${recipe._id}` } key={ recipe._id }>
                View Recipe
              </Link>
            </div>
          </div>
...
export default connect(mapStateToProps, { updateSelectedCategories, removeSelectedCategory })(RecipesShowSuggest);